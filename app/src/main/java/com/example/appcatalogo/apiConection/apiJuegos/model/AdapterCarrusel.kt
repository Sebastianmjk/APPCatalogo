...
class AdapterCarrusel(val juegosList : ArrayList<Result>) : RecyclerView.Adapter<AdapterCarrusel.ViewHolder>() {

    var onItemClick : ((Result) -> Unit)? = null

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        var idJuegos : Int = 0
        var imagenJuegos : ImageView = itemView.findViewById(R.id.ivGameHome)
